    ...
    <div class="flex flex-col xl:flex-row justify-center items-start w-full">
        <div
            ...
            <form action="/register" method="POST" class="flex flex-col mt-8 xl:mt-14 xl:w-80.5 w-full">
                ...
                <input type="text" value="<?= htmlspecialchars($pseudoOldValue) ?>" id="pseudo" name="pseudo" required
                    class="pl-3.5 focus:outline-cassian-green bg-cassian-white h-12.5 font-cassian-inter text-[14px] border border-cassian-border-form rounded-[10px] mt-2.5 w-full xl:w-80.5">
