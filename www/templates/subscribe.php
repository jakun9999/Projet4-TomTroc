...
<section class="grow w-full h-full bg-cassian-secondary max-w-94.25 xl:max-w-cassian-1440 mx-auto">
    <div class="flex flex-col xl:flex-row justify-center items-start w-full">
        <div
            class="flex flex-col justify-center items-start order-1 xl:order-1 px-5 xl:px-0 xl:ml-37.5 w-full xl:w-auto">
            <h1 class="font-cassian-playfair text-[30px] xl:text-[2.25rem] text-cassian-black mt-19.5 xl:mt-32.5">
                Inscription
            </h1>
            <form
                ...
                <input
                    type="text"
                    value="<?= htmlspecialchars($pseudoOldValue) ?>"
                    id="pseudo"
                    name="pseudo"
                    required
                    class="pl-3.5 focus:outline-cassian-green bg-cassian-white h-12.5 
                    font-cassian-inter text-[14px] border border-cassian-border-form 
                    rounded-[10px] mt-2.5 w-full xl:w-80.5">
                <?= $pseudoMessage !== '' ?
                    '<p class="mt-1 pl-3 font-cassian-inter text-[10px] text-red-500 italic">' .
                    htmlspecialchars($pseudoMessage) .
                    '</p>' :
                    '';  ?>
                <label
                    for="email"
