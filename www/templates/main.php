      ...
      <div id="nav-menu" class="items-end hidden w-full xl:flex xl:items-center xl:w-auto xl:grow flex-col xl:flex-row mt-4 xl:mt-0">
        ...
        <ul class="flex flex-col xl:flex-row gap-4 xl:gap-0 mb-4 xl:mb-0 items-end xl:items-stretch xl:w-full">
          <li class="flex xl:ml-19.5">
            <a class="flex items-center py-1 xl:py-0 text-[14px] font-cassian-inter transition-all duration-200 <?= $template === 'home' ? 'font-semibold text-cassian-black-light' : 'font-normal text-cassian-black-light hover:font-semibold' ?>" href="/home">Accueil</a>
          </li>
          <li class="flex xl:ml-11">
            <a class="flex items-center py-1 xl:py-0 text-[14px] font-cassian-inter transition-all duration-200 <?= $template === 'books' ? 'font-semibold text-cassian-black-light' : 'font-normal text-cassian-black-light hover:font-semibold' ?>" href="/books">Nos livres à l'échange</a>
          </li>
          <li class="flex xl:ml-auto">
            <a class="flex gap-1.5 items-center py-1 xl:py-0  text-[14px] font-cassian-inter transition-all duration-200 <?= $template === 'messaging' ? 'font-semibold text-cassian-black-light' : 'font-normal text-cassian-black-light hover:font-semibold' ?>" href="/messaging">
          ...
          <li class="flex xl:ml-14.5">
            <a class="flex gap-1.5 items-center py-1 xl:py-0 text-[14px] font-cassian-inter transition-all duration-200 <?= $template === 'account' ? 'font-semibold text-cassian-black-light' : 'font-normal text-cassian-black-light hover:font-semibold' ?>" href="/account">
