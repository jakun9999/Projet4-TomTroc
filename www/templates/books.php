...
?>
<section class="flex flex-col flex-1 justify-center w-full bg-cassian-secondary max-w-94.25 xl:max-w-cassian-1440 mx-auto">
    <div class="flex flex-col xl:flex-row gap-4.5 xl:justify-between xl:gap-0 xl:mx-66 mt-13.75 xl:mt-32.5 xl:items-center">
        <h1 class="font-cassian-playfair text-[30px] xl:text-[36px] text-cassian-black ml-5 xl:ml-0">Nos livres à l'échange</h1>
    ...
    <?php else: ?>
        ...
        <div id="no-results" class="hidden flex-1 flex-col justify-center items-center py-10">
            <h2 class="font-cassian-playfair text-[28px] text-cassian-black">Aucun livre ne correspond à votre recherche.</h2>
        </div>
    <?php endif; ?>
</section>