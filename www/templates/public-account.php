...
<section class="grow w-full h-full bg-cassian-secondary max-w-94.25 xl:max-w-cassian-1440 mx-auto">
    <div class="flex flex-col justify-center ml-5 xl:ml-37.5">
        ...
        <div class="flex flex-col xl:flex-row gap-8.25 xl:gap-7 mt-18.25 xl:mt-25.75">
            ...
            <div
                class="flex flex-col pt-12 xl:pb-14 rounded-[20px] items-center w-83.75 xl:w-85.25 h-144.75 bg-cassian-white">
                <!-- Photo and modify link -->
                <div class="flex flex-col items-center">
                    <img src="<?= $user->getPhoto() ?? '' !== '' ? htmlspecialchars($user->getPhoto()) : './assets/images/anonymous.png' ?>"
                        alt="" class="rounded-full w-33.75 h-33.75 object-cover">
                </div>
                <!-- separator -->
                ...
                <div class="flex flex-col items-center mt-12">
                    ...
                    <a href="/books"
                        class="flex justify-center items-center w-53.75 h-15.75 mx-auto mt-11.25 font-cassian-inter border text-cassian-green border-cassian-green font-semibold text-base rounded-[10px] transition-colors duration-300 ease-in-out hover:bg-cassian-green-strong hover:text-cassian-white">
                        Écrire un message
                    </a>
                </div>
            </div>
            ...
            <div class="flex flex-col rounded-[20px] w-83.75 xl:w-192.75 bg-cassian-white">
                ...
                <table class="w-full table-fixed">
                    ...
                    <tbody class="font-cassian-inter text-[12px]">
                        ...
                        <tr
                            class="odd:bg-cassian-white even:bg-cassian-gray-strong align-middle border border-cassian-primary">
                            <td class="pl-16.5 py-6.5">
                                <img src="<?= $book->getImageUrl() ?? '' !== '' ? htmlspecialchars($book->getImageUrl()) : './assets/images/new_book_cover.png' ?>"
